const RestoCard = (props) => {
  ...
  return (
    <div className="foodCard hover:bg-[#f0f0f0] hover:shadow-[1px_1px_5px_grey] hover:border hover:border-[#808080] h-64 w-60 p-1.5 mt-2.5 my-14 mx-6 ml-6 rounded-2xl bg-blue-100">
      <img
...
export const WithPromotedLabel = (RestoCard) => {
  return (props) => {
    return (
      <div>
        <label className=" absolute bg-[#242420] bg-opacity-95 text-white rounded-lg m-2 p-1 ">
          Promoted
        </label>
        <RestoCard {...props} />
      </div>
